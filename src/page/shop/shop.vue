                                    ...
                                    <li v-for="(value, index) in item.foods" :key="index">
                                        ...
                                        <section class="food-detail ellipsis">
                                            ...
                                            <div class="shopChoose">
                                                <v-cartControl
                                                    :food="value"
                                                    @getStartDotPosition="getStartDotPosition"
                                                />
                                            </div>
                                        </section>
                                    </li>
                                ...
                                <li class="rating-item">
                                    ...
                                    <div class="item-right">
                                        ...
                                        <div class="food-detail">
                                            ...
                                            <span
                                                v-for="value in item.item_ratings"
                                                :key="value.id"
...
export default {
    ...
    methods: {
            ...
            this.menuList.forEach((item, index) => {
                if (this.cartList[item.restaurant_id]) {
                    ...
                    if (currentShopCart[item.foods[0].category_id]) {
                        let num = 0;
                        Object.keys(
                            currentShopCart[item.foods[0].category_id]
                        ).forEach(itemid => {
                            Object.keys(
                                currentShopCart[item.foods[0].category_id][
                                    itemid
                                ...
                                if (item.type == 1) {
                                    ...
                                    if (foodItem.num > 0) {
                                        ...
                                        this.cartFoodList[cartFoodNum].num =
                                            foodItem.num;
                                        this.cartFoodList[cartFoodNum].price =
                                            foodItem.price;
                                        this.cartFoodList[cartFoodNum].name =
                                            foodItem.name;
                                        this.cartFoodList[cartFoodNum].specs =
                                            foodItem.specs;
                                        cartFoodNum++;
                                    }
                                }
        ...
        enter(el, done) {
            ...
            el.offsetHeight;
            const xDist =
                this.endDotPosition.elLeft - this.startDotPosition.elLeft;
            const yDist =
                this.endDotPosition.elTop - this.startDotPosition.elTop;
