<template>
  <div>
    <div class="user-info">
      ...
      <van-dialog v-model="show" title="标题" show-cancel-button message="是否确认退出" @confirm="outLogin"></van-dialog>
    </div>
  </div>
</template>
      ...
      if (this.userInfo) {
        ...
        try {
          let response = await fetch(
            "/api/users/update/avatar/" + this.userInfo.user_id,
            {
              method: "POST",
              credentials: "include",
              body: data
